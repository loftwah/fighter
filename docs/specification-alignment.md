...
| Tournament Trophies                  | Adopted owner extension 2026-07-31       | Every Tournament references one illustrated Trophy. First victory awards it idempotently to the selected Profile; reusable generic art supports custom Tournaments.                                                                                                                                                             |
| Story graph and replay               | Aligned                                  | No physical map; cleared nodes and branches remain replayable.                                                                                                                                                                                                                                                                  |
| Story completion and end game        | Adopted owner extension 2026-07-31       | A Story ends only after all declared Missions and Tournament Trophies are complete. The existing Quick Fight mode is the unrestricted post-Story sandbox.                                                                                                                                                                       |
