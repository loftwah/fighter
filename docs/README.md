...
| What belongs in V2.1 through V2.4                      | [Release roadmap](release-roadmap.md)                     |
...
3. [Game design](game-design.md) owns player-facing rules.
4. [Technical design](technical-design.md) owns architecture and persistence.
5. [`DESIGN.md`](../DESIGN.md) owns the implemented visual system.
6. [Brand and site](brand-and-site.md) owns public naming, domain, landing-page
   truth, and promotional presentation.
7. [Specification alignment](specification-alignment.md) records adopted,
   deferred, and rejected imported requirements.
8. [V2 source ledger](v2-source-ledger.md) preserves provenance and archive
   retrieval.
...
- [Multiplayer seam](multiplayer-seam.md) — deferred V2.4 boundary, protocol,
  Cloudflare direction, delivery ladder, and failure tests.
- [Audio plan](audio-plan.md) — music, SFX, dialogue, and fallback policy.
...
- [Multiplayer is the final planned feature milestone](decisions/0004-multiplayer-last.md)
