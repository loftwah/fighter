...
- Battle reference: the reference game informs only the structural relationship between a dominant charging bar and circular ability controls; loftwah/fighter keeps its own printed-object identity and semantics.
